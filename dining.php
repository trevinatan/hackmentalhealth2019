...
<head>
	...
	<link rel="stylesheet" href="assets/css/dining-style.css">
...
<body>
	...
	<img src="assets/img/dinner.jpg" style='position: fixed; top: 0; bottom: 0; z-index: -2; width: 100%; height: 100%'>
			</div>
	<div class = "logo">
		<h2><a href="home.html">LinkUp</a></h2>
	</div>
	<div id="main">
		<div id="title">DINING</div>
		<div id="where-box">
		<!-- WHERE Input field-->
		<!-- @source https://codepen.io/melnik909/pen/BZpJLN -->
			<form action="DiningInsert.php" method="post">
			<label class="field a-field a-field_a1 page__field">
		<!-- WHERE VARIABLE: "dining-where" -->
	      	<input class="field__input a-field__input" name="flocation" placeholder="e.g. Crossroads" required>
		...
		<!-- WHEN VARIABLE: "dining-when" -->
      		<input class="field__input a-field__input" name = "ftime" placeholder="e.g. 14:00" input="time" required>
      		<span class="a-field__label-wrap">
...
<!-- 			<form action="index.php" method="get">
 -->			<label class="field a-field a-field_a1 page__field">
		...
		<!-- PHONE # VARIABLE: "phone" -->
      		<input class="field__input a-field__input" name="fphonenumber" placeholder="e.g. 5105557777" type="int" required>
      		<span class="a-field__label-wrap">
